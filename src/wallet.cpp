        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            while (true) {
                ...
                if (nChange > 0) {
                    ...
                    // change transaction isn't always pay-to-blowsbig-address
                    CScript scriptChange;
...
bool CWallet::IsMine(const string& blowsbig_address)
{
    CBitcoinAddress check_address(blowsbig_address);
