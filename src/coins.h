...
/** 
    ...
    ****Note - for BSG we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of blowsbig coming in to a transaction
