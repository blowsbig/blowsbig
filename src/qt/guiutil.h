...
/** Utility functions used by the BSG Qt UI.
 */
namespace GUIUtil
{
...
// Render BSG addresses in monospace font
...
// Parse "blowsbig:" URI into recipient object, return true on successful parsing
