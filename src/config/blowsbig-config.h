/* src/config/blowsbig-config.h.  Generated from blowsbig-config.h.in by configure.  */
/* src/config/blowsbig-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_STRING "BSG Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "blowsbig"
