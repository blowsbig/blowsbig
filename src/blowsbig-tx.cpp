...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BSG blowsbig-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  blowsbig-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded blowsbig transaction") + "\n" +
                               "  blowsbig-tx [options] -create [commands]   " + _("Create hex-encoded blowsbig transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded blowsbig transaction
