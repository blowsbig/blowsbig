...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight % 43200 == 0) {
        ...
        else if (nHeight % 720 == 0) {
            nSubsidy = 720 * COIN;
        }
        else if (nHeight % 360 == 0) {
            nSubsidy = 360 * COIN;
        }
        else if (nHeight % 180 == 0) {
            nSubsidy = 180 * COIN;
        }
        else if (nHeight % 60 == 0) {
            nSubsidy = 60 * COIN;
        }
