...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BSG features */
        {"blowsbig", "masternode", &masternode, true, true, false},
        {"blowsbig", "listmasternodes", &listmasternodes, true, true, false},
        {"blowsbig", "getmasternodecount", &getmasternodecount, true, true, false},
        {"blowsbig", "masternodeconnect", &masternodeconnect, true, true, false},
        {"blowsbig", "masternodecurrent", &masternodecurrent, true, true, false},
        {"blowsbig", "masternodedebug", &masternodedebug, true, true, false},
        {"blowsbig", "startmasternode", &startmasternode, true, true, false},
        {"blowsbig", "createmasternodekey", &createmasternodekey, true, true, false},
        {"blowsbig", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"blowsbig", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"blowsbig", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"blowsbig", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"blowsbig", "getmasternodescores", &getmasternodescores, true, true, false},
        {"blowsbig", "mnbudget", &mnbudget, true, true, false},
        {"blowsbig", "preparebudget", &preparebudget, true, true, false},
        {"blowsbig", "submitbudget", &submitbudget, true, true, false},
        {"blowsbig", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"blowsbig", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"blowsbig", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"blowsbig", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"blowsbig", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"blowsbig", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"blowsbig", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"blowsbig", "checkbudgets", &checkbudgets, true, true, false},
        {"blowsbig", "mnsync", &mnsync, true, true, false},
        {"blowsbig", "spork", &spork, true, true, false},
        {"blowsbig", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"blowsbig", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use blowsbigd, or the -server option to blowsbig-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> blowsbig-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:11338/\n";
}
