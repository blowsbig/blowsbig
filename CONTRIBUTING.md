...
confused with overall BSG Network Protocol consensus changes.
...
Patches that change BSG consensus rules are considerably more involved than
...
Where a patch set proposes to change the BSG consensus, it must have been
