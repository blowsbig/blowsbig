...
In order to support loading of multiple wallets in blowsbig-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is blowsbig.cpp.
...
Changes to blowsbig.cpp
----------------------
blowsbig.cpp is the entry point into blowsbig-qt, and as such, will require some minor modifications to provide hooks for
